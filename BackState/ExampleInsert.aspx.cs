...
using DAL;
public partial class BackState_ExampleInsert : System.Web.UI.Page
{
    DExample info = new DExample();
    static Model.Example example = new Model.Example();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            Month.Text = Convert.ToString(DateTime.Now.Month);
    ...
    protected void Submit_Click(object sender, EventArgs e)
    {
        ...
        if (Pic.HasFile)
        {
            ...
            if (SaveImg(Pic, MapPath("~/FrontState/ExampleShow/ExampleImg")))
            {
                ...
                {
                    Response.Write("<script language='javascript'>alert('增添失败！')</script>");
