<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ArticleInsert.aspx.cs" Inherits="BackState_BlogsInsert" %>
         ...
         <legend>添加</legend>
            <div style=" width: 100%">
                <table>
                        ...
                        <tr>
                        <td>
                            <asp:Button ID="Insert" OnClientClick="return confirm('您确认加入该记录吗?')" runat="server" Text="提交" OnClick="Insert_Click" />
                        </td>
                    </tr>
                </table>
            </div>
