<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ArticleDelete.aspx.cs" Inherits="BackState_BlogsDelete" %>
...
<body>
    ...
    <div>
        <asp:DataList ID="Article" runat="server" Width="100%" OnItemCommand="DataList1_ItemCommand" >
            <HeaderTemplate>
            ...
            <ItemTemplate>
                    <tr>
                        ...
                        <td style="width:10%">
                            <asp:LinkButton ID="Update" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"id") %>' CommandName="GetArticleById" OnClientClick="return confirm('您确认删除该记录吗?')" runat="server" Text="删除" />
                        </td>
                    </tr>
            </ItemTemplate>
            <FooterTemplate>
